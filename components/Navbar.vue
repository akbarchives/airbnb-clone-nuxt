<template>
  <nav>
    ...
    >
      <div class="w-auto text-2xl font-bold sm:basis-1/3">
        <!-- logo in sm -->
        <svg
          width="30"
          height="32"
          class="hidden text-primary sm:block md:hidden"
        >
          <path
      ...
      <div
        class="hidden basis-1/3 flex-row items-center justify-end gap-4 sm:flex"
      >
        <div class="rounded-full p-2 px-4 filter-none hover:bg-slate-100">
          Airbnb your home
        </div>
    ...
    <div
      class="border-box flex h-20 flex-row items-end gap-12 overflow-hidden bg-white px-6 sm:px-8"
    >
      <div
