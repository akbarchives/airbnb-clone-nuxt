<template>
  <nav class="1000">
    <div
      class="flex h-20 flex-row items-center justify-center border-b bg-white px-6 sm:px-8"
    >
      <div
      ...
      >
        ...
        <svg
          width="30"
          height="32"
          class="hidden basis-2/12 text-primary sm:block md:hidden"
        >
          <path
        ...
        <!-- search button when:sm only -->
        <div class="hidden basis-auto sm:inline-block md:hidden">
          <a
            class="border-1 flex w-full cursor-pointer flex-row items-center justify-between rounded-full border px-2 py-1 shadow hover:shadow-md sm:px-2 sm:py-2"
          >
            <MagnifyingGlassIcon class="h-6 w-6 basis-2/12 sm:hidden" />
            <div class="flex basis-10/12 flex-col sm:basis-3/12">
              <!-- isi -->
              <p
                class="truncate px-2 text-left text-base font-semibold sm:basis-3/12 sm:text-center sm:text-sm sm:font-normal"
              >
                Anywheres
              </p>
              <div
                class="flex flex-row truncate pl-2 text-sm font-normal text-slate-500 sm:block sm:hidden sm:basis-3/12 sm:text-center sm:text-sm"
              >
                <p class="border-r pr-2">Any week</p>
                <p class="pl-2">Add guests</p>
              </div>
            </div>
            <p
              class="hidden border-x pl-2 text-center text-sm sm:block sm:basis-3/12 sm:truncate"
            >
              Any week
            </p>
            <p
              class="hidden pl-2 text-sm text-slate-500 sm:block sm:basis-4/12 sm:truncate"
            >
              Add Guest
            </p>
            <AdjustmentsHorizontalIcon class="h-6 w-6 basis-2/12 sm:hidden" />
            <MagnifyingGlassCircleIcon
              class="hidden h-8 w-8 basis-2/12 text-primary sm:block"
            />
          </a>
        </div>
        ...
        <!-- logo in md -->
        <svg
          class="hidden text-primary md:block"
          width="102"
          height="32"
        >
          <path
      ...
      <!-- Top Main Nav -->
      <div class="basis-full sm:hidden sm:basis-1/2 md:block md:basis-1/3">
        <!-- content -->
        <a
          class="border-1 flex cursor-pointer flex-row items-center justify-between rounded-full border px-2 py-1 shadow hover:shadow-md sm:px-2 sm:py-2"
        >
          <MagnifyingGlassIcon class="h-6 w-6 basis-2/12 sm:hidden" />
          <div class="flex basis-10/12 flex-col sm:basis-3/12">
            <!-- isi -->
      ...
      <div
        class="hidden flex-row items-center justify-end gap-4 sm:flex sm:basis-1/2 md:basis-1/3"
      >
        <div
          class="truncate rounded-full p-2 px-4 filter-none hover:bg-slate-100 sm:hidden sm:text-sm md:block md:text-base"
        >
          Airbnb your home
        </div>
    ...
    <div
      class="border-box flex h-20 flex-row items-end justify-between bg-white px-6 sm:px-8"
    >
      <div
        class="flex flex-row items-end gap-12 overflow-hidden bg-white sm:basis-[82%] lg:basis-[90%]"
      >
        <!-- categories -->
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/room.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Rooms</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/beach.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Beach</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Tropical.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Tropical</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/OMG.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">OMG!</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/cabins.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Cabins</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Camping.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Camping</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Design.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Design</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Arctic.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Arctic</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Vineyards.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Vineyards</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Beachfront.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Beachfront</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Boats.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Boats</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Golfing.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Golfing</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Hanoks.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Hanoks</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Islands.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Islands</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Trulii.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Trulli</p>
        </div>
        <div
          class="flex flex-col justify-center border-b-4 border-transparent text-center opacity-70 duration-200 hover:border-b-4 hover:border-black hover:opacity-100 hover:duration-200"
        >
          <img
            class="mx-auto h-8 w-8"
            src="~/assets/img/icon-category/Yurts.png"
            alt=""
          />
          <p class="py-1 text-sm font-medium">Yurts</p>
        </div>
      </div>
      <!-- filters -->
      <a
        href=""
        class="ml-2 hidden w-auto self-center rounded-2xl border text-center shadow hover:shadow-md sm:block"
      >
        <div class="px-3 py-3">
          <AdjustmentsHorizontalIcon class="mr-2 inline-block h-4 w-4" />
          <p class="mr-0 inline-block text-sm">Filter</p>
        </div>
      </a>
    </div>
  </nav>
